...
FEB_ASIC_CONNECTOR_CENTER=[6.5,MPPC_PITCH[1],0];
FEB_ASIC_CONNECTOR_POS=FEB_ASIC_CONNECTOR_CENTER-[FEB_ASIC_CONNECTOR_DIM[0]/2.,FEB_ASIC_CONNECTOR_DIM[1]/2.,0];
ASIC_FEB_CONNECTOR_DIM=[7.49,20.05,3.05];
...
ASIC_MODULE_PCB_CLEARANCE=[0.1,0.3,0];
FEB_ASIC_CONNECTOR_MATING_HEIGHT=25;
ASIC_MODULE_PCB_DIM=[ASIC_PITCH[0]-ASIC_MODULE_PCB_CLEARANCE[0],ASIC_PITCH[1]-ASIC_MODULE_PCB_CLEARANCE[1],18];
...
ASIC_MODULE_SCREW_DIAM=2.;
ASIC_MODULE_SCREW_LENGTH=15;
ASIC_MODULE_SCREW_POS=[0,0,2.55];
...
ASIC_MODULE_001_PCB_DIM=[4*MPPC_PITCH[0]-0.5*ASIC_MODULE_PCB_CLEARANCE[0],2*MPPC_PITCH[1]-0.5*ASIC_MODULE_PCB_CLEARANCE[1],2];
ASIC_MODULE_001_PCB_POS=[0.5*ASIC_MODULE_PCB_CLEARANCE[0],0.5*ASIC_MODULE_PCB_CLEARANCE[1],0];
...
ASIC_MODULE_001_FEB_CONNECTOR_DIM=[ASIC_FEB_CONNECTOR_DIM[1],ASIC_FEB_CONNECTOR_DIM[0],ASIC_FEB_CONNECTOR_DIM[2]];
//[20.05,7.49,3.05];
...
ASIC_MODULE_002_PCB1_POINTS=[[ASIC_MODULE_PCB_CLEARANCE[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_002_PCB1_DENTX*ASIC_MODULE_002_PCB1_DIM[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	...
	[(1-ASIC_MODULE_002_PCB1_DENTX)*ASIC_MODULE_002_PCB1_DIM[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_002_PCB1_DIM[0]-ASIC_MODULE_PCB_CLEARANCE[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_002_PCB1_DIM[0]-ASIC_MODULE_PCB_CLEARANCE[0],ASIC_MODULE_002_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]],
	[(1-ASIC_MODULE_002_PCB1_DENTX)*ASIC_MODULE_002_PCB1_DIM[0],ASIC_MODULE_002_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]],
	...
	[ASIC_MODULE_002_PCB1_DENTX*ASIC_MODULE_002_PCB1_DIM[0],ASIC_MODULE_002_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_PCB_CLEARANCE[1],ASIC_MODULE_002_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]]];
...
ASIC_MODULE_002_FEB_CONNECTOR_DIM=[ASIC_FEB_CONNECTOR_DIM[1],ASIC_FEB_CONNECTOR_DIM[0],ASIC_FEB_CONNECTOR_DIM[2]];
//[20.05,7.49,3.05];
...
ASIC_MODULE_003_PCB1_POINTS=[[ASIC_MODULE_PCB_CLEARANCE[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_003_PCB1_DENTX*ASIC_MODULE_003_PCB1_DIM[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	...
	[(1-ASIC_MODULE_003_PCB1_DENTX)*ASIC_MODULE_003_PCB1_DIM[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_003_PCB1_DIM[0]-ASIC_MODULE_PCB_CLEARANCE[0],ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_003_PCB1_DIM[0]-ASIC_MODULE_PCB_CLEARANCE[0],ASIC_MODULE_003_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]],
	[(1-ASIC_MODULE_003_PCB1_DENTX)*ASIC_MODULE_003_PCB1_DIM[0],ASIC_MODULE_003_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]],
	...
	[ASIC_MODULE_003_PCB1_DENTX*ASIC_MODULE_003_PCB1_DIM[0],ASIC_MODULE_003_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]],
	[ASIC_MODULE_PCB_CLEARANCE[0],ASIC_MODULE_003_PCB1_DIM[1]-ASIC_MODULE_PCB_CLEARANCE[1]]];
...
ASIC_MODULE_003_FEB_CONNECTOR_DIM=[ASIC_FEB_CONNECTOR_DIM[1],ASIC_FEB_CONNECTOR_DIM[0],ASIC_FEB_CONNECTOR_DIM[2]];
//[20.05,7.49,3.05];
...
ASIC_MODULE_004_PCB_DIM=[4*MPPC_PITCH[0]-1*ASIC_MODULE_PCB_CLEARANCE[0],2*MPPC_PITCH[1]-1.*ASIC_MODULE_PCB_CLEARANCE[1],2];
ASIC_MODULE_004_PCB_POS=[0.5*ASIC_MODULE_PCB_CLEARANCE[0],0.5*ASIC_MODULE_PCB_CLEARANCE[1],0];
ASIC_MODULE_004_PCB_POS0=ASIC_MODULE_004_PCB_POS+[-0.5*ASIC_MODULE_PCB_CLEARANCE[1],-0.5*ASIC_MODULE_PCB_CLEARANCE[1],0];
...
ASIC_MODULE_004_HOLES_DIAM=2.3;
ASIC_MODULE_004_HOLES_CENTERTOMARGIN=ASIC_MODULE_SCREW_POS[2];//2.55;
...
ASIC_MODULE_004_FEB_CONNECTOR_CENTER_POS=[FEB_ASIC_CONNECTOR_CENTER[0],0.5*ASIC_MODULE_004_PCB_DIM[1],0];
ASIC_MODULE_004_FEB_CONNECTOR_DIM=ASIC_FEB_CONNECTOR_DIM;
//[7.49,20.05,3.05];
ASIC_MODULE_004_FEB_CONNECTOR_POS=[ASIC_MODULE_004_FEB_CONNECTOR_CENTER_POS[0]-0.5*ASIC_MODULE_004_FEB_CONNECTOR_DIM[0],ASIC_MODULE_004_FEB_CONNECTOR_CENTER_POS[1]-0.5*ASIC_MODULE_004_FEB_CONNECTOR_DIM[1],ASIC_MODULE_004_FEB_CONNECTOR_CENTER_POS[2]-ASIC_MODULE_004_FEB_CONNECTOR_DIM[2]]+ASIC_MODULE_004_PCB_POS;
...
FEB_PCB_POS=[0.5*PCB_CLEARANCE,0.5*PCB_CLEARANCE,0];
FEB_PCB_ALPHA=1.;
...
for ( j = [0 : ASIC_NUMBER[1]-1] )
{
    translate([0,j*ASIC_PITCH[1], 0]+FEB_ASIC_CONNECTOR_CENTER+[ASIC_MODULE_PCB_CLEARANCE[0],0,0]+[FEB_2014_ASIC_CONNECTOR_DIM[0]*-0.5,FEB_2014_ASIC_CONNECTOR_DIM[1]*-0.5,FEB_2014_PCB_DIM[2]])//+FEB_2014_ASIC_CONNECTOR_POS)
...
for ( j = [0 : ASIC_NUMBER[1]-1] )
{
    translate([0,j*ASIC_PITCH[1], 0]+FEB_ASIC_CONNECTOR_CENTER+[ASIC_MODULE_PCB_CLEARANCE[0],0,0]+[FEB_2014_ASIC_CONNECTOR_DIM[0]*-0.5+ASIC_MODULE_PCB_DIM[0]+4*MPPC_PITCH[0]-2*FEB_ASIC_CONNECTOR_CENTER[0],FEB_2014_ASIC_CONNECTOR_DIM[1]*-0.5,FEB_2014_PCB_DIM[2]])//+FEB_2014_ASIC_CONNECTOR_POS)
    color(FEB_2014_ASIC_CONNECTOR_COLOR,alpha=FEB_2014_ASIC_CONNECTOR_ALPHA)
    cube(size = FEB_2014_ASIC_CONNECTOR_DIM,center=false);
}
echo(ASIC_MODULE_PCB_DIM[0]+4*MPPC_PITCH[0]-2*FEB_ASIC_CONNECTOR_CENTER[0]);
