...
//electronics_assembly_2014(FEB=true,mechanics=true,asics=true,crystal=false,mppc=false);
electronics_assembly_singleFEB_2014(FEB=true,mechanics=true,asics=true,crystal=true,mppc=true);
